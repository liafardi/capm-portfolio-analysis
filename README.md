...
Financial analysis using CAPM, Security Market Line and portfolio optimization with mean-variance methods
...
## Dataset
The dataset includes asset returns, market capitalizations, and risk-free rates.

The data were provided as part of an academic assignment and are not publicly available.  
